        ...
        >
          {categories.map((categorie, index) => (
            <div key={index} style={{ minWidth: `${cardWidth}px` }}>
              <div className="rounded-xl border overflow-hidden shadow-lg hover:shadow-2xl px-2 transition-transform transform hover:scale-105">
                <div className="rounded-xl h-80 w-[220px] flex justify-center items-center">
                  <Image
                    src={categorie?.image}
                    alt={categorie?.title}
                    layout="responsive"
